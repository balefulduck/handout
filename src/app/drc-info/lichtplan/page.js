  ...
  */
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <PageHeader title="Lichtplan" icon="/1.webp" />
      
      {/* Main Content */}
      <main className="container mx-auto max-w-5xl px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {/* Box 1: Was ist ein Lichtplan */}
          <InfoBox title="Was ist ein Lichtplan?">
            <p className="text-sm">Ein Lichtplan legt fest, wie lange Pflanzen täglich Licht erhalten sollen. Dieser Plan ändert sich je nach Wachstumsphase und Pflanzentyp.</p>
