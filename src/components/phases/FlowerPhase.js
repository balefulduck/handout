    ...
    <div className="py-4 px-3">
      <div className="max-w-3xl mx-auto">
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
          {/* Temperature Card */}
          <div className="bg-white rounded-xl shadow p-3 border-l-2 border-orange col-span-1">
          ...
          <div className="bg-white rounded-xl shadow p-3">
            <div className="flex items-center gap-2 mb-1.5">
              <PiTestTubeFill className="text-lg text-orange" />
          ...
          <div className="bg-white rounded-xl shadow p-3 border-l-2 border-orange col-span-2 sm:col-span-3">
            <div className="flex items-center gap-2 mb-1.5">
              ...
              <span className="text-lg font-medium underline">Blütephase</span>
            </div>
