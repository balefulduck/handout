    ...
    <>
      <div className="fixed top-0 left-0 right-0 z-50 bg-custom-orange shadow-lg">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-3">
            ...
            >
              <span className="text-sm font-semibold text-icon-purple">Dashboard</span>
            ...
            >
              <span className="text-sm font-semibold text-icon-purple">Pflanzen</span>
            ...
            >
              <span className="text-sm font-semibold text-icon-purple">Erste Hilfe</span>
            </button>
          </div>
        </div>
      </div>
      <div className="fixed bottom-0 left-0 right-0 z-50 bg-custom-orange shadow-lg border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-4">
          {pathname === '/dashboard' && (
            <div className="grid grid-cols-4 gap-3 py-2.5 px-2">
              <button
          ...
          {pathname === '/help' && (
            <div className="grid grid-cols-2 gap-3 py-2.5 px-2">
              <button
          ...
          {pathname === '/plants' && (
            <div className="grid grid-cols-1 py-2.5 px-2">
              <button
